...
Sequencing data has been uploaded to GEO with accession numbers [GSE307586](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE307586) for spatial data and [GSE307587](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE307587) for single nucleus data. Data from Xenium has also been uploaded to GEO with accession number [GSE325489](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE325489).
