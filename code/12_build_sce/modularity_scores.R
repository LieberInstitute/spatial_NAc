...
save(k_20_modularity,file = here("processed-data","12_snRNA","k_20_modularity_scores.rda"))

##Generate the heatmap
pdf(file = here("plots","12_snRNA","Dim_Red","k_20_pairwise_modularity_final_celltypes.pdf"),height = 15, width =15)
pheatmap(log2(k_20_modularity+1), 
         ...
         number_format="%.2f", 
         fontsize_number=6.5,
         main = "Modularity ratio for 45 graph-based clusters in human NAc (n=20)",
