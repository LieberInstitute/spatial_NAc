...
library(dplyr)
# read data 
dat_dir <- here("processed-data", "19_sLDSC_old", "10x_visium")
...
sig.ldsc$cell.ordered = factor(sig.ldsc$cell.ordered, levels=c("MSN 1","MSN 2", "MSN 3", "D1 islands","Inhibitory", "Excitatory", "Endothelial/Ependymal"))
