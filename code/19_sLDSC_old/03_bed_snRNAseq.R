...
cell <- read.csv(here::here("processed-data", "19_sLDSC_old", "snRNA_seq", "input_files", "snRNA_score.csv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("processed-data", "19_sLDSC_old", "snRNA_seq", "input_files", "bedfiles", filename)
