...
cell <- read.csv(here::here("processed-data", "19_sLDSC_old", "10x_visium", "input_files", "visium_score.csv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("processed-data", "19_sLDSC_old", "10x_visium", "input_files", "bedfiles", filename)
