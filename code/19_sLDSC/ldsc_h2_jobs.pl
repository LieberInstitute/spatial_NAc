...
open(OUT, ">ldsc_h2_jobs_meringue.txt");

opendir($dh, "/dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/19_sLDSC/meringue_factors/input_files/");
...
foreach $outdir (@outdirs){
	foreach $gwas(<*.gz>){
		...
		print OUT "--ref-ld-chr /dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/19_sLDSC/meringue_factors/input_files/${outdir}/chr.,$baseline2 ";
		print OUT "--overlap-annot ";
		print OUT "--frqfile-chr $freq ";
		print OUT "--out /dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/19_sLDSC/meringue_factors/sLDSC_coefficients/${outdir}/$out ";
