...
# Load libraries
library(here)
cell <- read.csv(here::here("processed-data", "19_sLDSC", "human_NAc_NMF", "input_files", "NMFs_score.csv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("processed-data", "19_sLDSC", "human_NAc_NMF","input_files", "bedfiles", filename)
