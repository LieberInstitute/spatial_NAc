...
# Load libraries
library(here)
cell <- read.csv(here::here("processed-data", "19_sLDSC", "10x_visium", "input_files", "10x_visium_score.csv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("processed-data", "19_sLDSC", "10x_visium","input_files", "bedfiles", filename)
