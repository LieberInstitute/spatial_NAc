...
$inputDir="/dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/19_sLDSC/meringue_factors/input_files";
open(OUT, ">ldsc_anno_jobs_meringue.txt");
