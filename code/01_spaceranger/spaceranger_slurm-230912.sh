...
#SBATCH -o logs/spaceranger_slurm_230912o.txt
#SBATCH -e logs/spaceranger_slurm_230912e.txt
#SBATCH --array=1-6
...
## Locate file
SAMPLE=$(awk "NR==${SLURM_ARRAY_TASK_ID}" samples_2023-09-12.txt)
...
date
mkdir -p /dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/01_spaceranger_reorg/
