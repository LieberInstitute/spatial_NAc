...
## Locate file
SAMPLE=$(awk "NR==${SGE_TASK_ID}" samples_2023-06-09_SPag051623.txt)
...
spaceranger count \
    ...
    --fastqs=${FASTQPATH}\
    --image=/dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/Images/VistoSeg/Capture_areas/round6/${SAMPLE}.tif \
    --slide=${SLIDE} \
    --area=${CAPTUREAREA} \
    --loupe-alignment=/dcs04/lieber/marmaypag/spatialNac_LIBD4125/spatial_NAc/processed-data/Images/loupe-alignment/round6/${SAM}.json \
    --jobmode=local \
    --localcores=8 \
    --localmem=64
