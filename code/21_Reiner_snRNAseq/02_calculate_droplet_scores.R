...
save(e.out,
     file = here("processed-data","21_Reiner_snRNAseq","droplet_scores",paste0(sample_run,"_droplet_scores.Rdata")))
...
ggsave(droplet_elbow_plot, 
       filename = here("plots","21_Reiner_snRNAseq","droplet_scores",paste0(sample_run,"_droplet_qc.png")))
