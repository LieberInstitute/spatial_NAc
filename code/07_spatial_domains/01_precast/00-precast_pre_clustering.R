...
out_path <- here("processed-data", "07_spatial_domains/01_precast/00_pre_clustering", paste0("PRECAST_k", k, ".csv"))
plot_dir <- here('plots', '07_spatial_domains', '01_precast', '00_pre_clustering')
