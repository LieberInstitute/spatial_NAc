...
if (opt$nnSVG_type) {
    ...
    if(opt$specify_k){
        if(random_start_test){
            out_path <- here("processed-data", "10_precast", "nnSVG_precast", paste0("random_start_", opt$random_seed))
            plot_dir <- here("plots", "10_precast", "nnSVG_precast", paste0("random_start_", opt$random_seed), paste0("cluster_k_", k))
        }else{
    ...
    if(opt$specify_k){
        if(random_start_test){
            out_path <- here("processed-data", "10_precast", "nnSVG_default", paste0("random_start_", opt$random_seed))
            plot_dir <- here("plots", "10_precast", "nnSVG_precast", paste0("random_start_", opt$random_seed), paste0("cluster_k_", k))
        }else{
