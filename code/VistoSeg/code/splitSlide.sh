...
#$ -pe local 7
#$ -o logs/06-02-2022_V11U08-082_Br8325_Round1_splitSlide.txt
#$ -e logs/06-02-2022_V11U08-082_Br8325_Round1_splitSlide.txt 
#$ -m e
...
matlab -nodesktop -nosplash -nojvm -r "addpath(genpath('$toolbox')), splitSlide('$fname',180,0,0,0)"
